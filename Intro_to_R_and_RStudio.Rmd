...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/abwilk/Documents/Fall 2023/QBIO 490/qbio_490_andrewwilk")) 
```
...
name <- "Andrew" # string
age <- 20 # int
birthday <- c(2,10,2003) # vector
three_fav_colors <- c("blue","green","orange") # vector
```
